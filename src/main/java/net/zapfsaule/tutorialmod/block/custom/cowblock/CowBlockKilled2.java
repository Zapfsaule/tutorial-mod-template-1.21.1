...
public class CowBlockKilled2 extends HorizontalFacingBlock {
    ...
    protected ItemActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (!world.isClient() && stack.getItem() == ModItems.BUTCHER_KNIFE) {
            ...
            world.setBlockState(pos, ModBlocks.COW_BLOCK_KILLED_3.getDefaultState().with(FACING, facing), Block.NOTIFY_ALL);
